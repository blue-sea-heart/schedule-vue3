...
import static com.blueseaheart.demo.domain.CategoryAsserts.*;
...
import com.blueseaheart.demo.repository.CategoryRepository;
import com.blueseaheart.demo.service.dto.CategoryDTO;
import com.blueseaheart.demo.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().name(DEFAULT_NAME).color(DEFAULT_COLOR);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().name(UPDATED_NAME).color(UPDATED_COLOR);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).color(UPDATED_COLOR);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).color(UPDATED_COLOR);
