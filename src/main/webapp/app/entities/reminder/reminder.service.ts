...
export default class ReminderService {
  find(id: number): Promise<IReminder> {
  ...
  create(entity: IReminder): Promise<IReminder> {
    return new Promise<IReminder>((resolve, reject) => {
      axios
  ...
  update(entity: IReminder): Promise<IReminder> {
    return new Promise<IReminder>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: IReminder): Promise<IReminder> {
    return new Promise<IReminder>((resolve, reject) => {
      axios
