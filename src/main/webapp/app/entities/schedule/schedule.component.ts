  ...
  setup() {
    ...
    const retrieveSchedules = async () => {
      ...
      try {
        ...
        const res = await scheduleService().retrieve(paginationQuery);
    ...
    const prepareRemove = (instance: ISchedule) => {
    ...
    const removeSchedule = async () => {
      try {
        await scheduleService().delete(removeId.value);
        const message = `A Schedule is deleted with identifier ${removeId.value}`;
